...
const GetLocation = ({ setroomlocation, roomlocation }) => {
    ...
    return (
        <div className='box mt-5 p-3'>
            <h1 className='heading-3'>Get your current classroom Location</h1>
            {Object.keys(roomlocation).length === 0 ? <>
                ...
                <button onClick={() => setroomlocation(location)} className='flex items-center bg-blue-400 text-white p-3 gap-3 my-6 mx-auto'><FaLocationDot /> Set Location</button>
            </>
                : <div className="flex flex-col items-center my-10">
                    <div className="w-24 h-24 rounded-full bg-green-100 flex items-center justify-center shadow-lg">
